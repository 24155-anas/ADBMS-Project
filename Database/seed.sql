...
(20, 1),   
(9,  1);   
INSERT INTO vehicles (licence_plate, model, seats, hourly_rate, is_available) VALUES
('LEA-1234', 'Toyota Corolla 2023',     5, 1500.00, TRUE),
('LHR-5678', 'Honda Civic 2024',        5, 1800.00, TRUE),
('ISB-9012', 'Suzuki Alto 2022',        4,  800.00, TRUE),
('KHI-3456', 'Toyota Yaris 2023',       5, 1200.00, TRUE),
('RWP-7890', 'Honda City 2024',         5, 1600.00, TRUE),
('FSD-2345', 'Suzuki Cultus 2023',      4,  900.00, TRUE),
('MUL-6789', 'Toyota Hilux 2023',       5, 2500.00, TRUE),
('PSH-0123', 'Kia Sportage 2024',       5, 3000.00, TRUE),
('QTA-4567', 'Hyundai Tucson 2023',     5, 2800.00, TRUE),
('SGD-8901', 'Suzuki Swift 2022',       4, 1000.00, TRUE);
...
(12, 8, '2026-02-10', '2026-02-12', 144000.00, 'active'),
(13, 9, '2026-02-12', '2026-02-14', 134400.00, 'active'),
(14, 1, '2026-02-15', '2026-02-17', 72000.00,  'pending'),
(2,  3, '2026-02-18', '2026-02-20', 38400.00,  'pending'),
...
(16, 6, '2026-02-15', '2026-02-18', 64800.00,  'pending');
...
(6,  7,  4, 'North Nazimabad, Karachi',     'Korangi, Karachi',            '2026-02-08 09:00:00', NULL,                  600.00,  'active'),
(8,  9,  5, 'G-9, Islamabad',              'I-8, Islamabad',              '2026-02-10 15:00:00', NULL,                  350.00,  'active'),
(13, 11, 6, 'Samanabad, Faisalabad',        'Jinnah Colony, Faisalabad',   '2026-02-12 12:00:00', NULL,                  220.00,  'pending'),
(14, 15, 7, 'Shah Rukn-e-Alam, Multan',     'Bosan Road, Multan',          '2026-02-14 08:00:00', NULL,                  280.00,  'pending'),
